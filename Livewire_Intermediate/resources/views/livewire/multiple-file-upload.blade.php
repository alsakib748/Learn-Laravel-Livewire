                            ...
                            @endif
                                <form wire:submit.prevent="createNewUserWithImage"  enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" wire:model="photos" accept="image/png, image/jpeg, image/jpg, image/webp" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" multiple >
                                        @error("photos")
                                            <span class="text-danger py-1">{{ $message }}</span>
                                        @enderror
